<template>
  <v-container>
    ...
    <v-row>
      <v-col cols="6">
        <ApexChart ref="TVOCSChart" type="line" height="350" :options="chartOptionsTVOCS" :series="seriesTVOCS"></ApexChart>
      </v-col>
      <v-col cols="6">
        <ApexChart ref="temperatureChart" type="line" height="350" :options="chartOptionsTemperature" :series="seriesTemperature"></ApexChart>
      </v-col>
    </v-row>
    <v-row>
      <v-col cols="12">
        <ApexChart ref="humidityChart" type="line" height="350" :options="chartOptionsHumidity" :series="seriesHumidity"></ApexChart>
      </v-col>
    </v-row>
...
export default {
  ...
  methods: {
    getWeatherData() {
      ...
      axios.get('http://35.203.60.205/weather-stats')
        .then(response => {
